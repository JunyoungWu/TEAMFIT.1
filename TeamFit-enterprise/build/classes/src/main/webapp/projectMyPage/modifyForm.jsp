...
%>
	...
	<form name="regForm" method="post" action="modifyProc.jsp">
		<table style="margin-left: 5%" border="1">
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="zipcode"
					value="<%=vo.getZipcode()%>" /> <input type="button" value="찾기"	onClick="zipCheck()" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="button"value="정보수정" onClick="updateCheck()" />&nbsp;&nbsp; 
					<input type="button" value="취소" onClick="javascript:window.location='index.jsp'" /></td>
			</tr>
		</table>
	</form>
